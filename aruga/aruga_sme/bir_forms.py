...
from aruga.aruga_sme.utils import get_company_information, get_supplier_information, get_employee_information, report_is_permitted
import pytz
import json
...
def bir_2307(company, supplier, employee, doctype, purchase_invoice, payment_entry, expense_claim, from_date, to_date, response_type="pdf"):
    ...
    from aruga.aruga_sme.report.bir_2307.bir_2307 import get_data as get_data_bir_2307
