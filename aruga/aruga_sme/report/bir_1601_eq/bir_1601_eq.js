...
frappe.query_reports["BIR 1601-EQ"] = {
    ...
    "onload": function (report) {
        report.page.add_inner_button(__("Print BIR 1601-EQ"), function () {
            ...
            var bir_form_url = frappe.urllib.get_full_url('/api/method/aruga.aruga_sme.bir_forms.bir_1601_eq?' + u + '&response_type=pdf');
        ...
        report.page.add_inner_button(__("Download QAP"), function () {
            ...
            var bir_form_url = frappe.urllib.get_full_url('/api/method/aruga.aruga_sme.bir_forms.bir_1601_eq_qap?' + u + '&response_type=download');
            let bir_form = window.open(bir_form_url);
        });
    }
};