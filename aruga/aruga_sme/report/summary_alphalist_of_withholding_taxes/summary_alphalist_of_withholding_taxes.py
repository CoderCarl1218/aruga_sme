...
from aruga.aruga_sme.utils import get_company_information, get_customer_information
from aruga.aruga_sme.bir_forms import return_document
    ...
    data = frappe.db.sql("""
        ...
        FROM
            ...
            SELECT 
                ...
                (pe.base_paid_amount_after_tax) as income_payment,
                atac.atc_rate,
